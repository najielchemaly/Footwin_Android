...
public class ScheduleAdapter extends BaseAdapter {
    ...
    public ScheduleAdapter(List<Match> root, Context context, ScheduleFragment scheduleFragment, String currentDate){
        this.root = root;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.schedule_match_row_item, null);
